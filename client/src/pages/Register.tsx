      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md text-center p-6">
          ...
          <div className="space-y-3">
            <Link href="/">
              <Button className="w-full bg-primary">Return Home</Button>
            </Link>
          </div>
        </Card>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <Link href="/">
            <a className="inline-flex items-center gap-2 font-serif text-2xl font-bold text-primary mb-4">
              <BookOpen className="h-8 w-8 text-secondary" />
              <span>Lamp Academy</span>
            </a>
          </Link>
          <h1 className="text-3xl font-serif font-bold text-slate-900">Student Registration</h1>
          ...
          <CardContent className="p-6 md:p-8">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="pt-6">
                  <Button type="submit" className="w-full bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold text-lg h-12">
                    Register Now
                  </Button>
                </div>
              </form>
